...
[CustomEditor(typeof(EInputEmitterGroup)), CanEditMultipleObjects]
public class EInputEmitterGroupCustomEditor : Editor
{
    ...
    {
        EInputEmitterGroup emitterGroup = (EInputEmitterGroup)target;
